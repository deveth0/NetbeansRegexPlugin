...
public class PrefsDialog extends javax.swing.JDialog {
    ...
    public boolean hasFlags() {
        return chCaseinsens.isSelected()
                || chMultiline.isSelected()
                || chDotall.isSelected()
                || chUnicodeCase.isSelected()
                || chCanonical.isSelected()
                || chUnixLines.isSelected()
                || chLiteral.isSelected()
                || chComments.isSelected()
                || chUnicodeClass.isSelected();
    }

    public String getFlagsJavaSource() {
        ...
        if (chUnicodeCase.isSelected()) {
            sb.append("Pattern.UNICODE_CASE|");
        }
        if (chCanonical.isSelected()) {
            sb.append("Pattern.CANON_EQ|");
        }
        if (chUnixLines.isSelected()) {
            sb.append("Pattern.UNIX_LINES|");
        }
        if (chLiteral.isSelected()) {
            sb.append("Pattern.LITERAL|");
        }
        if (chComments.isSelected()) {
            sb.append("Pattern.COMMENTS|");
        }
        if (chUnicodeClass.isSelected()) {
            sb.append("Pattern.UNICODE_CHARACTER_CLASS|");
        }
        // chop last pipe sign
