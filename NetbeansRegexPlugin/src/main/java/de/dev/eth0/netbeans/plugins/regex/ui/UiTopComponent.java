...
public final class UiTopComponent extends TopComponent {
    ...
    public UiTopComponent() {
        ...
        copyIcon = FontIcon.of(FontAwesome.COPY, UIManager.getColor("Button.foreground"));
        initComponents();
...
//        }
    ...
    private void initComponents() {
        ...
        bCopySource = new javax.swing.JButton();
        ...
        bCopySource.setIcon(copyIcon);
        bCopySource.setToolTipText(org.openide.util.NbBundle.getMessage(UiTopComponent.class, "UiTopComponent.bCopySource.toolTipText")); // NOI18N
        bCopySource.setMargin(new java.awt.Insets(2, 2, 2, 2));
        bCopySource.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bCopySourceActionPerformed(evt);
            }
        });
        ...
        pMatchLayout.setHorizontalGroup(
            ...
            .addGroup(pMatchLayout.createSequentialGroup()
                .addGap(61, 61, 61)
                .addComponent(cbRegex, 0, 140, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(bSave)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(bSettings)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(bCopySource)
                .addGap(6, 6, 6))
        );
        pMatchLayout.setVerticalGroup(
            ...
            .addGroup(pMatchLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(pMatchLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(bCopySource, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void bCopySourceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCopySourceActionPerformed
        StringBuilder sb = new StringBuilder("Pattern.compile(\"");
        sb.append(cbRegex.getSelectedItem().toString().replace("\\", "\\\\"));
        sb.append('"');
        if (prefDialog.hasFlags()) {
            sb.append(',').append(prefDialog.getFlagsJavaSource());
        }
        sb.append(")");
        this.getToolkit().getSystemClipboard().setContents(new StringSelection(sb.toString()), null);
    }//GEN-LAST:event_bCopySourceActionPerformed

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton bCopySource;
